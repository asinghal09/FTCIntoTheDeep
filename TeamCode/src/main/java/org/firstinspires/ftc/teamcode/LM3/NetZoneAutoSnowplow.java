...
@Autonomous
@Config
public class NetZoneAutoSnowplow extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory pickOne = drive.trajectoryBuilder(backUp.end())         //strafes to pick up 1st sample
                ...
                .addSpatialMarker(new Vector2d(20, 39), () -> {
        ...
        Trajectory pickTwo = drive.trajectoryBuilder(backUp2.end().plus(new Pose2d(0,0,Math.toRadians(220))))
                ...
                .build();
        Trajectory basketLineup2 = drive.trajectoryBuilder(strafeToTwo.end()) //goes to basket
        ...
        Trajectory push3 = drive.trajectoryBuilder(backUp3.end())
                .lineToSplineHeading(new Pose2d(60,20,Math.toRadians(180)))
                .build();
        ...
        slidesSubsystem.setSlides(300);
        slidesSubsystem.runArmToPos(300,0.4);
        ...
        slidesSubsystem.setSlides(300);
        drive.followTrajectory(push3);
        slidesSubsystem.runArmToPos(0,0.5);
        drive.followTrajectory(strafe3In);
